      ...
      <Container className="pb-5 px-4 px-md-5">
        ...
        <Row className="g-4 mb-5">
          <Col md={6}>
            <Card className="project-card">
              <a
                href="https://dapper-griffin-deda13.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
                <div className="img-container">
                  <img src="/stm.png" alt="project" />
                </div>
              </a>
              <Card.Body>
          ...
          <Col md={6}>
            <Card className="project-card">
              <a
                href="https://frabjous-pegasus-891fab.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
                <div className="img-container">
        ...
        <Row className="g-4 mb-5">
          <Col md={6}>
            <Card className="project-card">
              <a
                href="https://quiet-cheesecake-9b2e60.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
                <div className="img-container">
          ...
          <Col md={6}>
            <Card className="project-card">
              <a
                href="https://thriving-queijadas-7ed85d.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
                <div className="img-container">
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Modelado predictivo básico y dashboards interactivos utilizando Python y Power BI.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
        ...
        <Row className="g-4 mb-5">
          <Col md={6}>
            <Card className="project-card">
              <a
                href="https://2025-proyecto-grupo-09-0421f8.pages.fing.edu.uy/"
                target="_blank"
                rel="noreferrer"
              >
                <div className="img-container">
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Aplicación de técnicas básicas de procesamiento de imágenes y trabajo colaborativo.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
